...
/**
 * @module chorus
 * @description #### The top-level module for chorus.js, which exports all public classes in the [model](./module-model.html), [names](./module-names.html), and [structure](./module-structure.html) modules.
 *
